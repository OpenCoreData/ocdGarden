...
func ReadIGSNData() []CSDCOIGSN {
	...
	csvFile, err := os.Open("LacCore_Holes_20180910.csv") // note file name.. LacCore_Holes.csv    LacCore_Holes_20160915_trim.csv
	defer csvFile.Close()
	if err != nil {
		panic(err)
	}
...
func ReadMetaData() []CSDCO {
	// /Users/dfils/src/go/src/opencoredata.org/ocdBulk/CSDCOProjects/LacCore_Holes_20161010_trim_corrected.xlsx
	csvFile, err := os.Open("LacCore_Holes_20161010_trim_corrected.csv") // note file name.. LacCore_Holes.csv    LacCore_Holes_20160915_trim.csv
	defer csvFile.Close()
	if err != nil {
		panic(err)
	}
