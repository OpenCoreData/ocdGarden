...
The following is the out for test run.  
It is run against the following directory with a selection of folders in it.

```
Fils:CSDCODirWalkTests dfils$ ls -lt  /Volumes/Doug/WORK\ \(LinkStation\)/CSD\ data/
total 0
drwxrwxrwx@ 1 dfils  1168215819   264 Sep 28 21:03 WILL08 (Kirchner-JWilliams)
drwxrwxrwx@ 1 dfils  1168215819   432 Sep 28 21:02 CAHO
drwxrwxrwx@ 1 dfils  1168215819   264 Nov 13  2015 NAPALM (Walker)
drwxrwxrwx@ 1 dfils  1168215819  1078 Nov 13  2015 GLAD7 (Malawi)
```


```
CSDCO Directory walk filter testing
...
GeoTek High Res:
/Volumes/Doug/WORK (LinkStation)/CSD data/WILL08 (Kirchner-JWilliams)/Geotek Data/high-resolution MS data/WILL08_hrms_20080820/WILL08_hrms_20080820.xls
