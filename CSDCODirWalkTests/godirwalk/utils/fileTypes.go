...
func GetFileTypes() {
	...
	fta = append(fta, FileTypes{Name: " ", Regexpattern: "Images", URI: "http://opencoredata.org/id/voc/csdco/v1/image", Description: "Images of core section halves or core sections."})
