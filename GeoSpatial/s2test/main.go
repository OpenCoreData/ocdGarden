...
func main() {
	...
	enterDB(20.514981807048372, -155.9893798828125, "Around hawaii")            // POINT(-155.9893798828125 20.514981807048372)
	enterDB(20.546329665198517, -156.0552978515625, "Point off Maui")           // POINT(-156.0552978515625 20.546329665198517)
	enterDB(20.698436036336485, -156.29837036132812, "Kula Forset Reserve Mau") // POINT(-156.29837036132812 20.698436036336485)
	enterDB(19.005970464828987, -155.9454345703125, "Southern big island")      // POINT(-155.9454345703125 19.005970464828987)

	// POINT(-156.2200927734375 20.32498944633163)
	// POINT(-154.720458984375 18.870879505128975)
	rect := s2.RectFromLatLng(s2.LatLngFromDegrees(20, -156))
	rect = rect.AddPoint(s2.LatLngFromDegrees(19, -154))

	fmt.Println("\n----  rectangle search  -----")
	rc := &s2.RegionCoverer{MaxLevel: 15, MaxCells: 300}
	...
	ll1 := s2.LatLngFromDegrees(20.601936194281016, -158.060302734375)
	ll2 := s2.LatLngFromDegrees(19.621892180319374, -157.313232421875)
	ll3 := s2.LatLngFromDegrees(20.673905264672843, -154.87426757812497)
	ll4 := s2.LatLngFromDegrees(21.85130210558968, -155.85205078125)
	ll5 := s2.LatLngFromDegrees(20.601936194281016, -158.060302734375)
	...
	defaultCoverer := &s2.RegionCoverer{MaxLevel: 15, MaxCells: 8}
	...
	rc2 := &s2.RegionCoverer{MaxLevel: 15, MaxCells: 8}
