...
import (
	...
	"opencoredata.org/ocdGarden/CSDCO/GraphBuilder/internal/utils"
)
...
func BuildGraph() {
	...
	for _, item := range csvdata {
		...
		newpred1, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/ngdc_ship")
		newpred2, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/ngdc_cruise")
		newpred3, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/ngdc_sample")
		newpred4, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/ngdc_serial")
		newpred5, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/ngdc_comment")
		newpred6, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/location")
		newpred7, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/locationtype")
		newpred8, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/expedition")
		newpred9, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/locationid")
		newpred10, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/site")
		newpred11, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/hole")
		newpred12, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/sitehole")
		newpred13, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/originalid")
		newpred14, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/holeid")
		newpred15, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/platform")
		newpred16, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/date")
		newpred17, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/waterdepthm")
		newpred18, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/country")
		newpred19, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/state_province")
		newpred20, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/county_region")
		newpred21, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/pi")
		...
		newpred24, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/elevation")
		newpred25, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/position")
		newpred26, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/sampletype")
		newpred27, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/comment")
		newpred28, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/mblft")
		newpred29, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/mblfb")
		newpred30, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/metadatasource")
		newpred31, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/googleearthcommentfield")
		newpred32, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/platformname")
		newpred33, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/platformtype")
		newpred34, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/azimuth")
		newpred35, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/dip")
		...
		newobj0, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/CSDCOProject")
	...
	outFile, err := os.Create("./data/output/csdcoIGSN.nt")
	if err != nil {
		panic(err)
	}
	defer outFile.Close()
