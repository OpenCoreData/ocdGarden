...
func BoreholeDG(dm CSDCOBorehole) ([]byte, error) {
	...
	doc := map[string]interface{}{
		...
		"http://schema.org/spatialCoverage": map[string]interface{}{
			...
			"http://schema.org/geo": map[string]interface{}{
				"@type":                       "GeoCoordinates",
				"http://schema.org/latitude":  dm.Lat,
				"http://schema.org/longitude": dm.Long,
			},
		},
	...
	context := map[string]interface{}{
		"@context": map[string]interface{}{
			...
			"Azimuth":           "http://opencoredata.org/voc/csdco/v1/azimuth",
			"Dip":               "http://opencoredata.org/voc/csdco/v1/dip",
			"Elevation":         "http://opencoredata.org/voc/csdco/v1/elevation",
			"Lat":               "http://www.w3.org/2003/01/geo/wgs84_pos#lat",
			"Long":              "http://www.w3.org/2003/01/geo/wgs84_pos#long",
			"Water depth":       "http://opencoredata.org/voc/csdco/v1/water_Depth",
			"MBLF bottom":       "http://opencoredata.org/voc/csdco/v1/mblf_B",
			"MBLF top":          "http://opencoredata.org/voc/csdco/v1/mblf_T",
			"Site":              "http://opencoredata.org/voc/csdco/v1/site",
			"Comment":           "http://opencoredata.org/voc/csdco/v1/comment",
			"Country":           "http://opencoredata.org/voc/csdco/v1/country",
			"County Region":     "http://opencoredata.org/voc/csdco/v1/county_Region",
			"Date":              "http://opencoredata.org/voc/csdco/v1/date",
			"Expedition":        "http://opencoredata.org/voc/csdco/v1/expedition",
			"Hole":              "http://opencoredata.org/voc/csdco/v1/hole",
			"Hole ID":           "http://opencoredata.org/voc/csdco/v1/hole_ID",
			"IGSN":              "http://opencoredata.org/voc/csdco/v1/IGSN",
			"Location":          "http://opencoredata.org/voc/csdco/v1/location",
			"Location ID":       "http://opencoredata.org/voc/csdco/v1/location_ID",
			"Location Type":     "http://opencoredata.org/voc/csdco/v1/location_Type",
			"Metadata Source":   "http://opencoredata.org/voc/csdco/v1/metadata_Source",
			"Original ID":       "http://opencoredata.org/voc/csdco/v1/original_ID",
			"PI":                "http://opencoredata.org/voc/csdco/v1/pi",
			"Platform":          "http://opencoredata.org/voc/csdco/v1/platform",
			"Position":          "http://opencoredata.org/voc/csdco/v1/position",
			"Sample Type":       "http://opencoredata.org/voc/csdco/v1/sample_Type",
			"Site Hole":         "http://opencoredata.org/voc/csdco/v1/siteHole",
			"State or Province": "http://opencoredata.org/voc/csdco/v1/state_Province",
			"Platform Name":     "http://opencoredata.org/voc/csdco/v1/platform_name",
			"Platform Type":     "http://opencoredata.org/voc/csdco/v1/platform_type",
		},
	}
