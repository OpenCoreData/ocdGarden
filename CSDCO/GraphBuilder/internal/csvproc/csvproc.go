...
func BuildGraph() {
	...
	for _, item := range csvdata {
		...
		newpred1, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/locationname")
		newpred2, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/locationtype")
		newpred3, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/project")
		newpred4, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/locationid")
		newpred5, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/site")
		newpred6, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/hole")
		newpred7, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/sitehole")
		newpred8, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/originalid")
		newpred9, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/holeid")
		newpred10, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/platform")
		newpred11, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/date") // DCAT:issued
		newpred12, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/waterdepthm")
		newpred13, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/country")
		newpred14, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/state_province")
		newpred15, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/county_region")
		newpred16, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/pi")
		...
		newpred19, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/elevation")
		newpred20, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/position")
		newpred21, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/storagelocation")
		newpred22, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/storagelocation")
		newpred23, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/sampletype")
		newpred24, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/comment")
		newpred25, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/mblft")
		newpred26, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/mblfb")
		newpred27, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/metadatasource")
		newpred28, _ := rdf.NewIRI("http://opencoredata.org/voc/csdco/v1/latlong")
	...
	outFile, err := os.Create("./data/output/csdcoProjects.nt")
	if err != nil {
		panic(err)
	}
	defer outFile.Close()
